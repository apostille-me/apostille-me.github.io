...
test('landing page includes product storytelling sections', () => { assert.match(page, /id="platform"/); assert.match(page, /id="workflow"/); assert.match(page, /id="integrations"/); assert.match(page, /Apostille\ Me/); });
