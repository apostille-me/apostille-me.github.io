...
Preserve the responsive Astro product site, its production build and test scripts, configured GitHub Pages URL, SEO metadata, and deployment behavior. Do not replace working product content with a placeholder or generic template.
